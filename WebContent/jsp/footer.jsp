...
<script type="text/javascript"
	src="${ctx}/lib/js/jquery.matchHeight-min.js"></script>
<script type="text/javascript"
	src="${ctx}/lib/js/jquery.dataTables.min.js"></script>
<script type="text/javascript"
	src="${ctx}/lib/js/dataTables.bootstrap.min.js"></script>
<script type="text/javascript" src="${ctx}/lib/js/select2.full.min.js"></script>
